<html>
 ...
 <body>
        ...
        <form name="form" method="post" action="registration.php" enctype="multipart/form-data" style="margin-left: 43.4%; width: 40%;background: #FFFFFF;">
          ...
          <input type="submit" value="Зарегестрироваться" style="width:270px;height:75px;font-size:1.4vw">
        </form>
 </body>
</html>